# MCEdit-Unified code update python 3 code base
...
* [pygame 2.5+](http://pygame.org/install.html)
* PyOpenGL 3.1.7+
...
* cython 3.0+
* python-xlib 0.33+
* ftputil 5.1+ (Optional, but FTP server support will be disabled without it)
