...
class MCEdit(GLViewport):
    ...
    def resized(self, dw, dh):
        ...
        # Mac window handling works better now, but repr(win)
        ...
        # repr(win), otherwise it WOULD CRASH!!!
        # You cannot change further if statements like this
        # because they reference repr(win)
    ...
    def main(cls):
        ...
        ('MCEdit ~ ' + release.get_version() % _("for")), 'MCEdit'))
...
if __name__ == "__main__":
    try:
        ...
        print("==================================")
        eval(input("Press the Enter key to close this window"))
        pass
