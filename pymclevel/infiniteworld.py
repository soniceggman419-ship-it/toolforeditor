...
from pymclevel.mclevelbase import ChunkMalformed, ChunkNotPresent, ChunkAccessDenied,ChunkConcurrentException,exhaust, PlayerNotFound
...
class ChunkedLevelMixin(MCLevel):
    ...
    def generateLightsIter(self, dirtyChunkPositions=None):
        ...
        def reverseChunkPosition(chunk_pos):
            cx, cz = chunk_pos
            return cz, cx
...
class MCInfdevOldLevel(ChunkedLevelMixin, EntityLevel):
    ...
    This class is the type of the 'level' parameter that is passed to a filter's :func:repr(perform) function
    '''
    playersFolder = None
    ...
    def preloadChunkPositions(self):
        ...
        self._allChunks.update(self._loadedChunkData.keys())
    ...
    def addEntity(self, entityTag):
        ...
        try:
            ...
            return None
            # raise Error(c)an't find a chunk?
    ...
    def setPlayerPosition(self, pos, player="Player"):
        ...
        :param pos: The (x, y, z) coordinates
        :type pos: tuple
        :param player: The UUID of the player
        :type player: str
        '''
...
MCInfdevOldLevel.dirhashes = MCInfdevOldLevel._init_dirhashes()
